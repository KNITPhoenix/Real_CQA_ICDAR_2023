...
def run_eval(pred_dir, gt_dir, sd=None, pr_obj=None):
    _ = os.listdir(gt_dir)
    ...
    print('gt_dir',  gt_dir, len(_))
    for cix, chart in enumerate(_) :
        # print('Working on chart : ', chart)
        ...
        pred_qrel= {}
        gt_qrel= {}
        # print('Total ', len(gt_js), ' qa pairs')
        for gt in gt_js :
            gt_id = gt['qa_id']
            gt_ans = gt['answer']
    ...
    tidobj = np.load('C:/Users/spandey8/Desktop/evalPMC/t_id_map.npy', allow_pickle=True)
    tidobj = tidobj.item()
    agg = get_agg_tid(tidobj)
    
    cobj = np.load('C:/Users/spandey8/Desktop/evalPMC/ctype_id_map.npy', allow_pickle=True)
    cobj = cobj.item()
    ...
    print('Total Evaluated charts ', cix+1)
    ...
    print('Sample 2')
    print('-'*80)
    s2 = list(np.load('C:/Users/spandey8/Desktop/evalPMC/s2.npy'))
    ...
    print('Sample 3')
    print('-'*80)
    s3 = list(np.load('C:/Users/spandey8/Desktop/evalPMC/s3.npy'))
    ...
    print('Sample 4')
    print('-'*80)
    s3 = list(np.load('C:/Users/spandey8/Desktop/evalPMC/s4.npy'))
    ...
    print('Sample 5')
    print('-'*80)
    s3 = list(np.load('C:/Users/spandey8/Desktop/evalPMC/s5.npy'))
